...
```{r}
# Regression Model
Q1.reg <- Retail.data %>% feols(Employment.Status.numeric ~ i(covid.pre.post, ref = 'Before'))
etable(Q1.reg)
```
...
Q2.reg <- Translation.data %>% feols(Employment.Status.numeric ~ i(covid.pre.post, ref = 'After')*Retail.Trade.Employee)
